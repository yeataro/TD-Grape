...
commands.extend(['node', 'tests/unit/' + name] for name in (
    'test_functions_model.js', 'test_composite_exchange.js', 'test_graph_frames.js', 'test_top_source_clipboard.js', 'test_personal_model.js', 'test_editor_edits.js', 'test_editor_save_status.js', 'test_import_ui.js', 'test_spec_import.js', 'test_preview_controls.js'))
