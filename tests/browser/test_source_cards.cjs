...
(async()=>{
 ...
 try{
  ...
  assert.doesNotMatch(await page.locator('[data-input-source="color"] .source-card-body').innerText(),/TD · Colors/);
  await page.locator('[data-input-source="color"] .input-source-select').click();assert.match(await page.locator('#nodehelp').innerText(),/TD · Colors/);
