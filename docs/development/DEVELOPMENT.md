...
版本交付時同步核對 `runtime/sgrape_runtime.py` 的 `PRODUCT_VERSION`、`editor/index.html` 的標題列 `.brand-version` 與 About `.about-version`；三者應顯示相同產品版本，不能只更新 TD 端。2026-09-19 使用者回報標題仍停在 0.8.90，此核對納入後續交付步驟。
