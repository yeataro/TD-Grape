...
2026-09-21 最新需求：面板英文改為 Sources、中文為來源，且 TD 名稱／共同名稱入口須避免被誤認成搜尋選項；現行 0.8.163 尚未完成這兩項。此更新覆蓋下方早期「命名方向待定」的說法。與 Attribute／自訂參數等 Alpha 範圍一併記於 [Alpha 筆記](ALPHA_SCOPE_2026-09-21.md)，等使用者補充完再排程。
